...
:choice
	...
	:house1
		...
		if /I "%c%" EQU "Food" goto :eat1
		if /I "%c%" EQU "Broom" goto :takeWeaponBroom1
					...
					goto :humanFight1
						:humanDefend1Texture
							...
							:humanAttack1Texture
									...
									goto :humanAttack1
										:humanAttack1
											set /P c=You attacked, but you took 15 damage instead... You delt 10 damage though...
											if /I "%c%" EQU "Defend" goto :humanDefend2
											if /I "%c%" EQU "Attack" goto :humanAttack2
											goto :humanAttack1
												:humanDefend2
													echo This part is WIP, expect it within the next few builds!
													pause
													goto :choice
												:humanAttack2
													echo This part is WIP, expect it within the next few builds!
