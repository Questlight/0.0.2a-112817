																																																																																																							...
																																																																																																							:RIPBokar1Texture
																																																																																																								...
																																																																																																								goto :RIPBokar1
																																																																																																									:RIPBokar1
																																																																																																										...
																																																																																																										set /P c=You killed Bokar after he surrendered. Your reputation with the Hankorks has gone down by 45, making your reputation -45, and they now consiter you a Brutish Criminal. 																																																											:cry1
																																																...
																																																:gather3
																																																	...
																																																	goto :gather3
																																																		:day2
																																																			...
																																																			goto :day2
																																																				:furnish1
																																																					set /P c=You want to furnish %Shelter1Name%, but you don't have any furniture! [Create/Give Up]
																																																					if /I "%c%" EQU "Create" goto :create1
																																																					if /I "%c%" EQU "Give up" goto :giveUp1
																																																					goto :furnish1
																																																						:create1
																																																							set /P c=You look outside %Shelter1Name%. When you look out, you see some branches, a boulder, a deer, and tons of leaves. What do you want to make your new furniture out of? [Branches/Boulder/Deer/Leaves] 
																																																							if /I "%c%" EQU "Branches" goto :branch1
																																																							if /I "%c%" EQU "Boulder" goto :boulder1
																																																							if /I "%c%" EQU "Deer" goto :deerFight2Texture
																																																							if /I "%c%" EQU "Leaves" goto :leaves1
																																																							goto :create1
																																																								:branch1
																																																									set /P c=You decided to make your furniture out of the branches around you. What do you want to make first? [Chair/Table/Bed]
																																																									if /I "%c%" EQU "Chair" goto :chair1
																																																									if /I "%c%" EQU "Table" goto :table1
																																																									if /I "%c%" EQU "Bed" goto :bed1
																																																									goto :branch1
																																																								:boulder1
																																																								:deerFight2Texture
																																																									%texture%< textures/animals/deer/neutral.txt (
																																																									set /p var1=
																																																									set /p var2=
																																																									set /p var3=
																																																									set /p var4=
																																																								...
																																																								:leaves1
																																																						:giveUp1
																																																							echo Because the only thing you can do is explore, you're going exploring!
																																																							pause
																																																							goto :explore2
																																																	:eat3
