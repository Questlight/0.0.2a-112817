			...
			goto :confirmName
				...
				:choice
					...
					:house1
						...
						set /P c=You go to th	e house. Inside, you find some food, a broom, and someone sleeping. What do you do?[Food/Broom/Wake] 
																																																							...
																																																							:run4
																																																								...
																																																								goto :homeless1
																																																									:homeless1
																																																										...
																																																										if /I "%c%" EQU "Explore" goto :explore1
																																																										goto :homeless1
																																																											:explore1Texture
																																																												echo          /\
																																																												echo         /  \
																																																															...
																																																															:build3Texture
																																																																...
																																																																goto :build3
																																																																	:build3
																																																																		...
																																																																		goto :confirmName2
																																																																			:confirmName2
																																																																				set /P c=So you want to name it %Shelter1Name%? [Y/N]
																																																											...
																																																											:cry1
																																																												...
																																																												goto :cry1
																																																					:confirmMove1
																																																						set /P c=Are you SURE you want to move? You cannot move back to %Shelter1Name%! [Y/N]
																																																						if /I "%c%" EQU "Y" goto :move1
																																																						if /I "%c%" EQU "N" goto :noMove1
																																																							:noMove1
																																																								echo Ok.
																																																								pause
																																																								goto :run3
																																																	:stay1
																																																		echo You decided to stay at the stick...
																																																		pause
																																																		goto :net1
																																																			:net1
																																																				set /P c=You got caught in a net! What do you do? [Yell/Cut]
																																																				if /I "%c%" EQU "Yell" goto :yell1
																																																				if /I "%c%" EQU "Cut" goto :cut1
																																																				goto :net1
																																																					:yell1
																																																						echo Thank you for following the development of Questlight 0.0.4a!
																																																						echo/
																																																						echo This is the end for now!
																																																						pause
																																																					:cut1
																																																						echo Thank you for following the development of Questlight 0.0.4a!
																																																						echo/
																																																						...
																																																						pause
																																															:gather5
																																																set /P c=You decide to gather the berries you saw last night. You managed to gather 50 berries. Do you want to save the berries, or eat them now? [Eat/Store]
																																																if /I "%c%" EQU "Eat" goto :eat4
																																																if /I "%c%" EQU "Store" goto :store1
																																																goto :gather5
																																															:upgrade2
